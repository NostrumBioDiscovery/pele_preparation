...
def main(mae_file, max_tors, nrot, user_core_atom, mae_charges = False, clean = False, gridres = "10.0", nstd=None):
...
def parse_args():
    ...
    return args.mae_file, args.mtor, args.n, args.core, args.mae_charges, args.gridres, args.clean, args.nstd

if __name__ == "__main__":
    mae_file, mtor, n, core, mae_charge, gridres, clean, nstd = parse_args() 
    template, rotamers_file = main(mae_file, mtor, n, core, mae_charge, clean, gridres, nstd)
